                        ...
                        <Table size="small" aria-label="purchases">
                            <TableHead>
                                <TableRow sx={{'td, th': { py: 0.2, px: 0.2, border: 0 }}}>
                                    ...
                                    <TableCell align="center">C. Prog</TableCell>
                            ...
                            <TableBody>
                                {detalle.filter(item => asignado && asignado.id !== 'TODOS' ? item.documento === asignado.num_doc : item)
                                        .filter(item => almacen && almacen.id !== 'TODOS' ? item.id_almacen === almacen.id : item)
                                        .map((item) => {
                                    return <TableRow key={item.id} sx={{
                                        ...
                                        <TableCell align="left">
                                            <p>{item.documento} - {item.asignado}</p>
                                        </TableCell>
                                        <TableCell>
                                            <p>{item.cuenta}</p>
                                        </TableCell>
...
const DespachoSolicitudPage = () => {
    ...
    const loadPage = React.useCallback(async () => {
        ...
        let data = await listarPorCodigoDeSolicitud(ids_solicitudes, token, tokenCompany);
        console.log('DATA DE DESPACHO: ', data)
...
export default DespachoSolicitudPage
