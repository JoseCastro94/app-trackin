...
import {LISTAR_DETALLE_POR_ID_SOLICITUD} from "../database/queries/detalle-solicitud-query.js";
...
class DetalleSolicitudArticuloRepository {

    static listarPorIdSolicitud = async (id_solicitud, IdEmpresa, IdAlmacenes) => {
        return sequelize.query(LISTAR_DETALLE_POR_ID_SOLICITUD, {
...
export default DetalleSolicitudArticuloRepository
